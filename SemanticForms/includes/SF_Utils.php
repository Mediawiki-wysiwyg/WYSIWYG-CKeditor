...
END;
	...
	public static function addJavascriptFiles( $parser ) {
		//global $wgOut, $wgJsMimeType;                               //26.03.14 RL SF-Wysiwyg#6 
        global $wgOut, $wgFCKEditorDir, $wgScriptPath, $wgJsMimeType; //26.03.14 RL SF-Wysiwyg#6 
		...
		if ( $wgFCKEditorDir && class_exists( 'CKEditor' ) ) {
          $scripts[] = "$wgScriptPath/$wgFCKEditorDir/ckeditor.js";
          // http://x.x.x.x/mediawiki/extensions/WYSIWYG/ckeditor/ckeditor.js
		}
		//26.03.14 RL SF-Wysiwyg#6<-
